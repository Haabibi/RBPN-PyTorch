...
class FlowNetC(nn.Module):
    ...
    def forward(self, x):
        ...
        #print("FlowNetC [L92]: ", out_conv_redir.shape, out_corr.shape, in_conv3_1.shape) 
        # Merged conv layers
        ...
        #print("FlowNetC [L111]: ", out_conv4.shape, out_deconv4.shape, flow5_up.shape, concat4.shape)
        flow4       = self.predict_flow4(concat4)
        flow4_up    = self.upsampled_flow4_to_3(flow4)
        out_deconv3 = self.deconv3(concat4)
        #print("FlowNetC [L116] " , out_conv3_1.shape, out_deconv3.shape, flow4_up.shape)
